...
////// 		turnaround mode end
	...
	private void ProcessBodySpecialData(ref KinectInterop.BodyData bodyData)
	{
        ...
        //Debug.Log("x: " + bodyData.joint[(int)KinectInterop.JointType.FootLeft].kinectPos.x);
        //Debug.Log("y: " + bodyData.joint[(int)KinectInterop.JointType.FootLeft].kinectPos.y);
        //Debug.Log("z: " + bodyData.joint[(int)KinectInterop.JointType.FootLeft].kinectPos.z);
